...
namespace SquirrelDebugEngine {
    public abstract class IComponentBase : IDkmCustomMessageForwardReceiver, IDkmCustomMessageCallbackReceiver {
        ...
        static IComponentBase() {
            // Register all known message types. 
            foreach (var type in typeof(IComponentBase).Assembly.GetTypes()) {
        ...
        public IComponentBase(Guid sourceId) {
            _sourceId = sourceId;
        }
