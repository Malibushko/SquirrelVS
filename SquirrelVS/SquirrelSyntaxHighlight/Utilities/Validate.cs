...
namespace SquirrelSyntaxHighlight.Utilities
{
    /// <summary>
    ...
    internal static class Validate
    {
        ...
        /// </summary>
        /// <param name="conditionToCheck">The value of the parameter being validated.</param>
        /// <param name="valueToCheck">The value of the parameter being validated.</param>
        public static void IsFalse(bool conditionToCheck)
        {
            if (conditionToCheck)
            {
