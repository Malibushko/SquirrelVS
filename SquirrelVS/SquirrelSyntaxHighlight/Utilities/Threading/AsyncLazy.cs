...
namespace SquirrelSyntaxHighlight.Utilities.Threading
{
    /// <summary>
    ...
    internal sealed class AsyncLazy<T>
    {
        ...
        private static readonly IEnumerable<Request> EmptyRequests = new Request[0];
        ...
        private void CompleteWithTask(Task<T> task, CancellationToken cancellationToken)
        {
            ...
            using (TakeLock(cancellationToken))
            {
                ...
                requestsToComplete = _requests ?? EmptyRequests;
                _requests = null;
