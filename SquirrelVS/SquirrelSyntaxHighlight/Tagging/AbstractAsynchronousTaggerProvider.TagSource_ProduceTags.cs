...
using SquirrelSyntaxHighlight.Editor.Shared;
using SquirrelSyntaxHighlight.Editor.Tagging;
using SquirrelSyntaxHighlight.Options;
using SquirrelSyntaxHighlight.Text;
using SquirrelSyntaxHighlight.Editor.Shared.Tagging;
