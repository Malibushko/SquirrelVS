...
using SquirrelSyntaxHighlight;
using Microsoft.CodeAnalysis.Options;
using Microsoft.VisualStudio.Text;
using Microsoft.VisualStudio.Text.Editor;
using Microsoft.VisualStudio.Text.Tagging;
using SquirrelSyntaxHighlight.Editor.Shared.Extensions;
using SquirrelSyntaxHighlight.Editor.Shared.Utilities;
using SquirrelSyntaxHighlight.Shared;
using SquirrelSyntaxHighlight.Text.Shared.Extensions;
...
namespace SquirrelSyntaxHighlight.Editor.Tagging
{
    ...
    internal abstract partial class AbstractAsynchronousTaggerProvider<TTag> : ForegroundThreadAffinitizedObject where TTag : ITag
    {
        ...
        internal ITagger<T> CreateTaggerWorker<T>(ITextView textViewOpt, ITextBuffer subjectBuffer) where T : ITag
        {
            ...
            return new Tagger(_asyncListener, _notificationService, tagSource, subjectBuffer) as ITagger<T>;
        }
