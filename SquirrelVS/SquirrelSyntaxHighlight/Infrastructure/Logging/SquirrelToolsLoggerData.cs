...
namespace SquirrelSyntaxHighlight.Logging {
    /// <summary>
    /// Provides a base class for logging complicated event data.
    /// </summary>
    abstract class SquirrelToolsLoggerData {
        public static IDictionary<string, object> AsDictionary(object obj) {
            ...
            if (!(obj is SquirrelToolsLoggerData)) {
                return null;
            }
        ...
        //                value = new TelemetryPiiProperty(value);
                    ...
                    Debug.Fail(ex.ToUnhandledExceptionMessage(typeof(SquirrelToolsLoggerData)));
                }
            }
            return res;
        }
    ...
    sealed class PackageInfo : SquirrelToolsLoggerData {
        [PiiProperty]
        public string Name { get; set; }
    }

    sealed class AnalysisInitialize : SquirrelToolsLoggerData {
        [PiiProperty]
    ...
    sealed class AnalysisInfo : SquirrelToolsLoggerData {
        [PiiProperty]
        public string InterpreterId { get; set; }
        public int AnalysisSeconds { get; set; }
    }

    sealed class LaunchInfo : SquirrelToolsLoggerData {
        public bool IsDebug { get; set; }
        public bool IsWeb { get; set; }
        public string Version { get; set; }
    }

    sealed class AnalysisTimingInfo : SquirrelToolsLoggerData {
        public string RequestName { get; set; }
        public int Milliseconds { get; set; }
        public bool Timeout { get; set; }
    }

    sealed class DebugReplInfo : SquirrelToolsLoggerData {
        public bool RemoteProcess { get; set; }
        public string Version { get; set; }
    }

    sealed class GetExpressionAtPointInfo : SquirrelToolsLoggerData {
        public int Milliseconds { get; set; }
    ...
    sealed class CondaEnvCreateInfoBarInfo : SquirrelToolsLoggerData {
        public string Reason { get; set; }
    ...
    sealed class VirtualEnvCreateInfoBarInfo : SquirrelToolsLoggerData {
        public string Action { get; set; }
        public string Context { get; set; }
    }

    sealed class ConfigureTestFrameworkInfoBarInfo : SquirrelToolsLoggerData {
        public string Action { get; set; }
        public string Context { get; set; }
    }
    ...
    sealed class PackageInstallInfoBarInfo : SquirrelToolsLoggerData {
        public string Action { get; set; }
        public string Context { get; set; }
    }

    sealed class CreateCondaEnvInfo : SquirrelToolsLoggerData {
    ...
    sealed class CreateVirtualEnvInfo : SquirrelToolsLoggerData {
        public bool Failed { get; set; }
    ...
    sealed class AddExistingEnvInfo : SquirrelToolsLoggerData {
        public bool Failed { get; set; }
        public string LanguageVersion { get; set; }
        public string Architecture { get; set; }
    ...
    sealed class SelectEnvFromToolbarInfo : SquirrelToolsLoggerData {
        [PiiProperty]
        public string InterpreterId { get; set; }
        public string Architecture { get; set; }
        public string Version { get; set; }
    ...
    sealed class FormatDocumentInfo : SquirrelToolsLoggerData {
        public string Version { get; set; }
    ...
    sealed class UntrustedWorkspaceInfoBarInfo : SquirrelToolsLoggerData {
        public string Action { get; set; }
    }
