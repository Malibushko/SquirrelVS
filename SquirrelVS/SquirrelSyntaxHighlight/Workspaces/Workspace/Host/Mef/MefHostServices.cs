...
namespace SquirrelSyntaxHighlight.Host.Mef
{
    public class MefHostServices : HostServices, IMefHostExportProvider
    {
        ...
        private static ImmutableArray<Assembly> LoadDefaultAssemblies()
        {
            ...
            {
                "SquirrelSyntaxHighlight.Workspaces",
                "SquirrelSyntaxHighlight.Hlsl.Workspaces",
                "SquirrelSyntaxHighlight.ShaderLab.Workspaces",
                "SquirrelSyntaxHighlight.Features",
                "SquirrelSyntaxHighlight.Hlsl.Features",
                "SquirrelSyntaxHighlight.ShaderLab.Features"
            };
